...
namespace Acore
{
    ...
    WorldObjectSpellAreaTargetCheck::WorldObjectSpellAreaTargetCheck(float range, Position const* position, Unit* caster,
        ...
        : WorldObjectSpellAreaTargetCheck(range, position, caster, referer, spellInfo, selectionType, condList, Acore::WorldObjectSpellAreaTargetSearchReason::Area, TARGET_REFERENCE_TYPE_CASTER)
    {
    }
